        ...
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="bg-[#0d0d0d] border border-zinc-800 rounded-2xl p-8 max-w-sm w-full text-center space-y-4">
            ...
            <p className="txt-small text-zinc-500">
              {isAr ? "أكمل استمارة التسجيل قبل رفع أي مشاركة." : "Complete your registration form before submitting content."}
            </p>
            <Link href="/submissions/register"
              className="block w-full py-3 bg-[#78be20] hover:bg-[#8fd428] text-black font-display font-semibold uppercase txt-small rounded-xl transition-colors duration-200 text-center">
      ...
      <AuthShell>
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="bg-[#0d0d0d] border border-yellow-400/20 rounded-2xl p-8 max-w-sm w-full text-center space-y-4">
            <div className="w-12 h-12 rounded-full bg-yellow-400/10 border border-yellow-400/30 flex items-center justify-center mx-auto text-2xl">
              ⏳
            </div>
            ...
            <div className="flex flex-col gap-2">
              <Link href="/submissions"
                className="block w-full py-3 bg-zinc-800 hover:bg-zinc-700 text-white font-medium txt-small rounded-xl transition-colors duration-200 text-center">
                {isAr ? "عرض مشاركاتي" : "View My Submissions"}
              </Link>
              <Link href="/auth/profile"
                className="block w-full py-3 text-zinc-500 hover:text-white txt-smaller transition-colors duration-200 text-center">
