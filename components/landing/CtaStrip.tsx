    ...
    <section
      className="w-full text-center relative overflow-hidden">
        <div className="absolute size-full inset-x-0 top-14">
          ...
          <span className="absolute inset-0 bg-monster opacity-80 pointer-events-none"
            style={{
      ...
      <FadeInView className="relative z-1 pt-60 pb-20 flex flex-col items-center justify-center">
        <h2
