    ...
    <section id="levels" className="w-screen py-25 px-35 relative">
      ...
      <div className="container relative z-2">
        <FadeInView className="text-center mb-16">
          <h2
            className="header-larger font-display font-black text-white tracking-wide uppercase mb-4">
            {t("levelingSystem")}
          </h2>
            ...
            return (
              <motion.div
                ...
                <Link
                  ...
                  className="block p-8 h-full overflow-hidden relative"
                  style={{
                    ...
                    <span className="absolute top-0 -left-2 h-2 w-1/2 skew-x-[-45deg]" style={{backgroundColor: color}} />
                  <h3
                    ...
                    {(isAr ? rank.requirementsAr : rank.requirementsEn)
                      ...
                      .map((req) => (
                        <div key={req} className="flex items-start gap-3">
                          <div className="mt-1.5 shrink-0 size-2 relative" style={{ background: color }}>
                            <span className="absolute size-1 bg-[#ccc] rounded-full -inset-e-0.5 -top-0.5 z-0"></span>
                          </div>
