  ...
  return (
    <section
      ...
      <div className="container relative z-10 mb-52.5 pt-62.5 overflow-visible px-4 sm:px-6 rtl:-scale-x-100">
        ...
        <div className="flex">
          {/* Left third */}
          <div className="w-1/3 shrink-0 py-5 -mt-5 sm:-mt-10 border-e border-[rgba(204,204,204,0.4)]">
          ...
          {/* Right third */}
          <div className="w-1/3 shrink-0 py-5 -mt-5 sm:-mt-10 border-s border-[rgba(204,204,204,0.4)]">
            <div className="border-t border-[rgba(204,204,204,0.4)]" />
          </div>
        </div>
    ...
    <motion.div
      ...
      <Link
        ...
        <div className="news-card-info relative w-full sm:w-1/2 shrink-0 pt-5 sm:pt-7.5 px-5 sm:px-7.5 pb-16 sm:pb-20 bg-[#171717] group-hover:shadow-[inset_0_0_25px_5px_#363636] transition-all duration-500">
          ...
          {/* Title */}
          <h3 className="txt-larger sm:header-small text-white font-bold mb-4 sm:mb-6.25">
            {isAr ? article.titleAr : article.title}
          </h3>

          {/* Excerpt */}
          <p className="font-proxima txt-regular sm:header-smaller text-[#b6b6b6] font-semibold not-italic">
